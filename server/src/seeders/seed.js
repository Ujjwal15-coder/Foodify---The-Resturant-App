...
const seedData = async () => {
  try {
    ...
    const foodsData = [
      ...
      // ▸ Sagar Ratna (5 items)
      { name: 'Masala Dosa', restaurant: r('Sagar Ratna'), category: 'south-indian', description: 'Crispy golden dosa filled with spiced potato masala, served with sambhar & coconut chutney', price: 149, foodType: 'veg', isBestseller: true, avgRating: 4.5, totalRatings: 6500, totalOrders: 18000, preparationTime: 15, thumbnail: '/assets/food_dosa.png', nutrition: { calories: 380, protein: 10, fat: 14, carbs: 56 }, tags: ['bestseller'] },
      ...
      { name: 'Paneer Tikka Starter', restaurant: r('Barbeque Nation'), category: 'starters', description: 'Chargrilled cottage cheese cubes marinated in tandoori masala, served with mint chutney & grilled veggies', price: 349, foodType: 'veg', isBestseller: true, avgRating: 4.5, totalRatings: 3500, totalOrders: 8000, preparationTime: 20, thumbnail: '/assets/food_paneer_tikka.png', tags: ['bestseller'] },
      { name: 'Chicken Seekh Kebab', restaurant: r('Barbeque Nation'), category: 'starters', description: 'Minced chicken kebabs seasoned with aromatic spices, grilled on skewers until perfectly charred', price: 399, foodType: 'non-veg', avgRating: 4.6, totalRatings: 4100, totalOrders: 9500, preparationTime: 20, thumbnail: '/assets/food_seekh_kebab.png' },
